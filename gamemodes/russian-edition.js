...
function Player(text, difficulty) {
    this.text = text;
	this.style = text;
...
players[0] = new Player("conservative", 1);
players[1] = new Player("communist", 2);
players[2] = new Player("populist", 2);
players[3] = new Player("socialist", 3);
players[4] = new Player("traditionalist", 3);
players[5] = new Player("economist", 3);
players[6] = new Player("democrat", 3);
players[7] = new Player("liberal", 4);
players[8] = new Player("green", 4);
players[9] = new Player("monarchist", 4);
players[10] = new Player("right", 4);
players[11] = new Player("pirate", 4);
players[12] = new Player("ultraconservative", 4);
players[13] = new Player("progressivist", 5);
players[14] = new Player("nationalist", 5);
players[15] = new Player("libertartian", 5);
players[16] = new Player("marxist", 5);
